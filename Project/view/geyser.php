...
background-image: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%);
	...
	<title>Geyser Repair</title>

<?php
include "header.php";                 
?>
	<h1 align="middle">Geyser Repairing Services</h1>
</head>

<body>

<div align="middle">
	<img src="../images/geyser2.jpg" alt="ovan" width="1000" height="550">
</div>
...
<div>
	...
	<h2>Pricing</h2>
	<ul>
		<li>You only have to pay the service charge including materials/parts cost (if taken)</li>
	</ul>
	<hr>
